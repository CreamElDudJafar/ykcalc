...
$(".set-selector").change(function () {
	...
	if ($(this).hasClass('opposing')) {
		...
		for (var party_i = 0; party_i < next_poks.length; party_i++) {
			...
			// Calculator uses the canonical curly-apostrophe species name,
			// while the sprite repository uses the ASCII filename.
			...
			// Same simple clickable party-icon structure as BKCalc.
